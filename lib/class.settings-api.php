 ...
 *
 * @author SMS Alert <pankaj@mobikasa.com>
 * @link https://smsalerts.io
 * @example src/settings-api.php
 */
			...
			<?php foreach ( $this->settings_sections as $form ) { ?>
				<div id="<?php echo $form['id']; ?>" class="group" style="display: none;">
					<form method="post" action="options.php">
						...
						<div style="padding-left: 10px; display:inline-block;">
							<p><a href="https://smsalerts.io/user/store/dashboard" id="get-started" class="button button-primary" target="_blank">Show Transaction Details</a></p>
						</div>
                        <div style="padding-left: 10px; display:none;">
                            <p><a href="<?php echo get_site_url(); ?>/wp-admin/options-general.php?page=smsalert-woocoommerce-setting&view-details=true" name="details" id="details" class="button button-primary">Show Transaction Details</a></p>
                        </div>

						<div style="padding-left: 10px; display:inline-block;">
							<p><a href="https://smsalerts.io/get-started" id="get-started" class="button button-primary" target="_blank">Getting Started</a></p>
						</div>
					</form>
				</div>
			<?php } ?>
